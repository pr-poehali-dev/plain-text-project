    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Не все товары одинаково прибыльны. 20% позиций обычно дают 80% выручки. Это ваши "чемпионы".
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Ещё 30% - "рабочие лошадки", которые приносят стабильный, но небольшой доход.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Остальные 50% - "балласт", который съедает рекламный бюджет, но почти не даёт продаж.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Стандартный подход - крутить рекламу на всё подряд и надеяться на лучшее.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Бюджет размазывается тонким слоем. "Чемпионы" недополучают показов, "балласт" съедает деньги.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
