    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Система "Товарный Снайпер" работает иначе. <span className="sm:inline block sm:mt-0 mt-4">Мы анализируем ваш каталог, выделяем прибыльные позиции и направляем бюджет именно на них.</span>
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
