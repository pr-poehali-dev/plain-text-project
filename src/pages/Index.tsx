    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Утро понедельника. Вы открываете Яндекс.Метрику или отчёт от подрядчика. Смотрите на цифры. Клики есть - 1200 за неделю. Бюджет потрачен - 45 000 рублей.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Заказов... три. Может, пять. Стоимость заказа - 9000 рублей. При марже 2000.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Вы листаете отчёт дальше. Пытаетесь понять, куда ушли деньги. Открываете статистику по поисковым запросам. И видите: по запросу "зелёная подушка 50х50" были показы и клики на... синюю подушку 40х40.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Это, как если бы вы искали смартфон Samsung Galaxy S24 с памятью 128 GB в сером цвете. По клику на рекламу открылась страница с карточкой «Смартфон Samsung Galaxy S24» с памятью 256 GB в синем цвете, цена не та что была в объявлении.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Когда человек ищет "зелёная подушка 50х50" - Яндекс находит в фиде именно её. Показывает объявление с фотографией зелёной подушки 50х50.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Человек кликает и попадает в карточку зелёной подушки 50х50. Видит то, что искал. Добавляет в корзину.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Не все товары одинаково прибыльны. 20% позиций обычно дают 80% выручки. Это ваши "чемпионы". <span className="sm:inline block">Ещё 30% - "рабочие лошадки", которые приносят стабильный, но небольшой доход.</span>
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Остальные 50% - "балласт", который съедает рекламный бюджет, но почти не даёт продаж.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Стандартный подход - крутить рекламу на всё подряд и надеяться на лучшее. <span className="sm:inline block">Бюджет размазывается тонким слоем. "Чемпионы" недополучают показов, "балласт" съедает деньги.</span>
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Система "Товарный Снайпер" работает иначе. Мы анализируем ваш каталог, выделяем прибыльные позиции и направляем бюджет именно на них.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
