    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Система "Товарный Снайпер" работает иначе. <span className="sm:inline block sm:mt-0 mt-4">Я анализирую ваш каталог, выделяю прибыльные позиции и направляю бюджет на них.</span>
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Использую стратегии с оплатой за ДРР от дохода - реклама автоматически перераспределяет деньги от низкомаржинальных товаров к высокомаржинальным.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <section className="mb-12 bg-gray-50 p-8 rounded-lg">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Начинаю с ABC-анализа вашей товарной матрицы.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Разделяю весь ассортимент на три категории:
          </p>
          <ul className="space-y-3 mb-6 text-lg text-gray-700 leading-relaxed ml-6">
            <li className="flex items-start">
              <span className="mr-3">•</span>
              <span><strong>Группа А</strong> - ваши "чемпионы". 20% товаров, которые дают 80% выручки. На них направляю максимум внимания и бюджета.</span>
            </li>
            <li className="flex items-start">
              <span className="mr-3">•</span>
              <span><strong>Группа B</strong> - "рабочие лошадки". 30% товаров, которые приносят стабильный доход. Работаю над повышением их эффективности.</span>
            </li>
            <li className="flex items-start">
              <span className="mr-3">•</span>
              <span><strong>Группа C</strong> - "кандидаты на вылет". 50% товаров, которые съедают бюджет, но почти не дают продаж. Отключаю их из рекламы или ищу способы сделать рентабельными.</span>
            </li>
          </ul>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
