    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Человек видит в рекламе синюю подушку. Он искал зелёную, но кликает - вдруг на сайте есть нужная. Вы платите за клик. <span className="sm:inline block sm:mt-0 mt-4">Он переходит на карточку, видит синюю подушку, начинает искать зелёную, не находит быстро, раздражается, уходит.</span>
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
