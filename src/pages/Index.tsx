    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16 sm:px-8 lg:px-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Всё начинается с авторской настройки выгрузки товаров. Каждый вариант товара становится отдельной позицией.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Зелёная подушка 50х50 - отдельная позиция со своими изображением, заголовком, ссылкой.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Зелёная подушка 40х40 - отдельная позиция со своим изображением, заголовком, ссылкой.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            И так далее.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            У каждого товара все атрибуты и характеристики при себе. Директ получает чёткие данные и может подобрать 100% релевантный товар под каждый запрос.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
